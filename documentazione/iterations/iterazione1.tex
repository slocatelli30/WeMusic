...
\begin{comment}
    L'architettura di Django si basa sul design pattern MVC, acronimo di Model View 
    ...
    Riassumendo:
    M - Model: “data access layer” - Definisce la struttura delle entità del nostro sito, tradotte 
    poi in tabelle nel database. 
    T - Template: “presentation layer” - Descrive come i dati vadano mostrati nelle pagine web.
    V - View: “business logic layer” - Gestisce le richieste e le risposte HTTP, dispone della 
    logica per sapere a quali dati accedere tramite i model e delega la formattazione della risposa ai template

    Nel model ho le classi, nella view i metodi. 
