...
utenti, crearne di nuovi, aggiornare i loro dettagli e eliminarli.
I campi in tabella sono elencati di seguito:
\begin{itemize}
    \item \textbf{Metodo:} indica il tipo di operazione che può essere eseguita 
        sull'endpoint specificato; quelli comuni e tradizionali includono i metodi HTTP (get, post, put, delete), 
...
\subparagraph{Autenticazione, Account} In figura sono presenti tutte le interfacce
