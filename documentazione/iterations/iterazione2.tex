...
sistema risulta come segue in \ref{fig-uml-component-diag_2} e \ref{fig-uml-component-diag_4}. Per 
aumentare la comprensione la rappresentazione del sistema è stata divisa in due. 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.64]{component_diagram_V3_3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.64]{component_diagram_V3_4.png}
    \caption{UML Component Diagram}
