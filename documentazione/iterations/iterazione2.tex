...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{4.} L'utente ha scaricato correttamente il brano.
    \end{itemize}
    \item \textbf{Exception Sequence:} Connessione fallita.
\end{itemize}
\vspace{1cm}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{3.} Il brano sarà visibile fra i brani preferiti, quindi l'utente ha completato correttamente l'operazione.
    \end{itemize}
    \item \textbf{Exception Sequence:} Connessione fallita.
\end{itemize}
\vspace{1cm}
...
\begin{itemize}
    ...
    \item \textbf{Postcondition:} L'utente può consultare il contenuto della playlist, perciò potrà navigare nell'elenco 
    ...
    \begin{itemize}
        ...
        \item \textbf{3.} L'utente può navigare fra i brani contenuti nella playlist, quindi ha correttamente eseguito l'operazione.
    \end{itemize}
    \item \textbf{Exception Sequence:} Non è stata creata alcuna playlist dall'utente o connessione fallita.
\end{itemize}
\vspace{1cm}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{3.} L'utente ha correttamente eliminato la playlist, che non sarà più visibile nell'elenco.
    \end{itemize}
